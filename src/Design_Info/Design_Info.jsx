                ...
                <div className="row">
                    ...
                    <div className="col-lg-4" data-aos="zoom-in" data-aos-duration="1500">
                        <div className="details-style">
                            ...
                            <h3>High Quality</h3>
                            <p>High-quality website design work encompasses meticulous attention to detail, thoughtful user experience, visually appealing layouts</p>
                        </div>
                    </div>
                    ...
                    <div className="col-lg-4" data-aos="zoom-in-up" data-aos-duration="1500">
                        <div className="details-style">
                            ...
                            <h3>Awesome Idea</h3>
                            <p>Create a seamless and intuitive user interface. Ensure that navigation is easy to understand and navigate</p>
                        </div>
                    </div>
                </div>
            </div>
